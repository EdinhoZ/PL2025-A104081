...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','calc_yacc.py',35),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','calc_yacc.py',39),
  ('expression -> term','expression',1,'p_expression_term','calc_yacc.py',43),
  ('term -> term TIMES factor','term',3,'p_term_times','calc_yacc.py',47),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','calc_yacc.py',51),
  ('term -> factor','term',1,'p_term_factor','calc_yacc.py',57),
  ('factor -> NUMBER','factor',1,'p_factor_number','calc_yacc.py',61),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','calc_yacc.py',65),
]
